        ...
        linhaenviar.forEach(function(value, index) {
            setTimeout(
                function() {
                  ...
                  var sec = $("#sec").val();
                            $.ajax({
                        url: 'skbase.php?lista=' + value + '&sec=' + sec + '&proxy=' + proxy,
                        async: true,
...
<div class="card col-sm-12">
  <span class="badge badge-info"><h4>Gate 3 - SK_LIVE</h4></span>
  <div class="card-body">
<div class="md-form">
	<div class="col-md-12">
...
<span class="badge badge-white"<label for="lista">Cards</label></span>
<br>
...
<br>
<span class="badge badge-danger"><label for="sec">Secret Key Here.</label></span>
<br>
<textarea class="md-textarea form-control" style="text-align: center;" rows="1" id="sec" placeholder="Sk_Live_xxxxxxxxx"></textarea>
<br>
<class="md-textarea form-control" style="text-align: center;" rows="5" id="proxy" placeholder="Proxy:Port">
 </center>
&nbsp;<br>
