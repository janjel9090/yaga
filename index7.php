...
<div class="card col-sm-12">
  <span class="badge badge-info"><h4>SK_KEY CHECKER </h4></span>
  <div class="card-body">
<div class="md-form">
	<div class="col-md-12">
...
<span class="badge badge-danger"<label for="lista">Keys</label></span>
<br>
<textarea type="text" style="text-align: center;" id="lista" class="md-textarea form-control" rows="50" placeholder="FORMAT: sk_live_xxxxxxxxxxxxx" ></textarea>
<br>
