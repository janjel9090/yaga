...
<span class="badge badge-danger"<label for="lista">Proxies Type: HTTP/HTTPS</label></span>
<br>
...
<center>
 <button class="btn btn-primary" style="width: 140px; outline: none;" id="testar" onclick="enviar()" >START</button>
 
 &nbsp;
  <button class="btn btn-success" style="width: 140px; height:40px; outline: none; padding-right:25px" id = "prox">
...
<div class="card">
  ...
  <script>
    $('document').ready(function(){
      $('#prox').click(function(){
        $('#lista').val('Downloding proxies...');
        $.ajax({
          url: 'scrap.php',
          error: function() {
            $('#lista').val('Ooops, an error has occurred !');
          },
