...
<div class="card col-md-12">
  <span class="badge badge-info"><h4>Gate 1 - [CCN]_[CVV]</h4></span>
  <div class="card-body">
<div class="md-form">
	<div class="col-md-12">
...
<br>
<class="md-textarea form-control" style="text-align: center;" rows="7" id="proxy" placeholder="PROXY:PORT">
 </center>
&nbsp;<br>
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <div id="bode2"><span id=".reprovadas" class="reprovadas"></span><br>
    </div>
  </div>
</div>
</div>
