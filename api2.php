...
elseif(strpos($result2, 'Your card has insufficient funds.')) {
  fwrite(fopen('insufficient.txt', 'a'), $lista."\r\n");
   echo '<span class="badge badge-success">#Aprovada</span> </span> <span class="badge badge-danger">'.$lista.'</span> <span class="badge badge-success"> '.$mesg.' | INSUFF</span> </span><br> ';
}
elseif (strpos($result2, "Invalid source object: must be a dictionary or a non-empty string.")) {
  echo '<span class="badge badge-danger">DIE</span> <span class="badge badge-dark">' . $lista . '</span> <span class="badge badge-danger"></span> <span class="badge badge-danger"><b>GENERIC PHARMACY  </span><br> ';
}
elseif (strpos($result2, ',"cvc_check":"unavailable",')) {
  echo '<span class="badge badge-danger">DIE</span> <span class="badge badge-dark">' . $lista . '</span> <span class="badge badge-danger"></span> <span class="badge badge-danger"><b>unavailable  </span><br> ';
}
 else {
  fwrite(fopen('dead.txt', 'a'), $lista."\r\n");
  echo '<span class="badge badge-danger">DIE</span> <span class="badge badge-dark">' . $lista . '</span> <span class="badge badge-danger"></span> <span class="badge badge-danger"><b>'.$cvvcheck.''.$mesg.' </b> </span><br>';
}
  curl_close($curl);
  ob_flush();
