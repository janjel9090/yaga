      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">ℤ𝕪𝕟𝕔</a>
          </div>
          </div>
      </nav>
...
<div class="card col-sm-12">
  <span class="badge badge-info"><h4>ADMIN</h4></span>
  <div class="card-body">
<div class="md-form">
	<div class="col-md-12">
...
<class="md-textarea form-control" style="text-align: center;" rows="1" id="proxy" placeholder="proxy:port">
 </center>
&nbsp;<br>
      ...
      <footer class="footer">
        <div class="container-fluid">
          <div class="copyright">
            ...
            <a href="javascript:void(0)" target="_blank">ℤ𝕪𝕟𝕔</a>
          </div>
        </div>
      </footer>
    </div>
